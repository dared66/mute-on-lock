...
Thank you for helping improve Mute on Lock.

1. Open an issue for behavior changes or larger work before investing in an
   implementation.
...
4. For release changes, run `bash scripts/build-release.sh` and upload the two
   files in `dist/`.
